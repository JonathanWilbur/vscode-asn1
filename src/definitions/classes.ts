...
export const UNIVERSAL_DEFINITION : MarkdownString = new MarkdownString(
"An ASN.1 tag class used for ASN.1 elements whose data types are one of \
those defined by the ASN.1 specification."
);

export const PRIVATE_DEFINITION : MarkdownString = new MarkdownString(
...
export const APPLICATION_DEFINITION : MarkdownString = new MarkdownString(
...
export const CONTEXT_SPECIFIC_DEFINITION : MarkdownString = new MarkdownString(
