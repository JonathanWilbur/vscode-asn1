...
function suggestGeneralizedTime(line, lineNumber, diagnostics) {
    ...
    do {
        ...
        if (indexOfMinMax !== -1) {
            ...
            var diag = new vscode_1.Diagnostic(range, "Consider using GeneralizedTime instead of UTCTime", vscode_1.DiagnosticSeverity.Warning);
...
//# sourceMappingURL=utctime.js.map